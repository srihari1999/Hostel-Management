   ...
   while($row1 = mysqli_fetch_assoc($result1)){
     ...
     if($result3){
     	...
     	if($result4){
     		...
     		echo "<script type='text/javascript'>alert('Failed to allocate again again.....')</script>";
     	}
     }
     else {
     	echo "<script type='text/javascript'>alert('new failed to allocate Rooms')</script>";
     }
